...
ALTER VIEW public.daily_metrics_summary SECURITY INVOKER;
ALTER VIEW public.subscription_analytics SECURITY INVOKER;
ALTER VIEW public.beta_code_performance SECURITY INVOKER;
ALTER VIEW public.user_activity_metrics SECURITY INVOKER;
