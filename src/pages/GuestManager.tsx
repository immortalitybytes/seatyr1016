...
const GuestManager: React.FC = () => {
  ...
  const loadTestGuestList = () => {
    ...
    const testGuests = [
      ...
      { id: 'guest_test_15', name: 'Priya Sharma + 1', count: 2 },
      ...
      { id: 'guest_test_19', name: 'Tyler Goldberg + 3', count: 4 },
      { id: 'guest_test_20', name: 'Stephanie & Robert Jackson', count: 2 },
      { id: 'guest_test_21', name: 'Nicole White', count: 1 },
      { id: 'guest_test_22', name: 'Diego Thunberg', count: 1 },
      { id: 'guest_test_23', name: 'Jin Wang', count: 1 },
      { id: 'guest_test_24', name: 'Rachel Franklin', count: 1 },
      { id: 'guest_test_25', name: 'Zander & Victoria Lee', count: 2 },
      { id: 'guest_test_26', name: 'Sergio Gambuto', count: 1 },
      { id: 'guest_test_27', name: 'Kayla & Daveed Lopez', count: 2 },
      { id: 'guest_test_28', name: 'Ravi Berns-Krishnan + wife', count: 2 },
      { id: 'guest_test_29', name: 'Kenji Nakamura + 2', count: 3 },
      { id: 'guest_test_30', name: 'Megan Kaczmarek', count: 1 }
    ];
